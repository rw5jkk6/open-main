...
def main():
    ...
    mess_over = myfont.render("kawanami san", True, (255, 255, 0))
    mess_over1 = myfont.render("LINE", True, (255, 255, 0))
    mess_over2 = myfont.render("Please ", True, (255, 255, 0))
    fps = 30
    ...
    while True:
        ...
        if BALL.rect.centery > 800 and len(BLOCKS) > 0:
            SURFACE.blit(mess_over, (130, 400))
            SURFACE.blit(mess_over1, (200, 500))
            SURFACE.blit(mess_over2, (200, 600))
